...
assert.equal(files.length, 27, "expected the complete 27-migration release chain");
...
const requiredOrder = [
  ...
  ["20260909110000", "CREATE OR REPLACE FUNCTION public.resolve_user_plus_entitlement"],
