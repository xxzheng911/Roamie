...
assert(computeItineraryResolvedTarget(4) === 16, `target4=${computeItineraryResolvedTarget(4)}`);
assert(computeItineraryResolvedTarget(3) === 12, `target3=${computeItineraryResolvedTarget(3)}`);
