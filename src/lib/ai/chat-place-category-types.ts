...
const CATEGORY_PLACE_QUERY_RE =
  /(?:咖啡廳|咖啡店|咖啡|café|cafe|餐廳|美食|吃飯|用餐|吃的地方|想吃|吃什麼|找吃的|商圈|shopping|百貨|市集|購物|商場|mall|夜市|酒吧|居酒屋|宵夜|室內景點|雨天|美術館|博物館|museum|必去景點|必去|景點|有推薦的(?:餐廳|咖啡|店|地方|景點|美食)|推薦(?:餐廳|咖啡|景點|商圈|百貨|夜市|酒吧|店|地方|吃)|有什麼(?:商圈|景點|店|地方)|附近有什麼|有推薦的店)/i;
