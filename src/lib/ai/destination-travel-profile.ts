import { canonicalEditorialTheme } from "@/lib/ai/combination-theme-titles";
/**
...
> = {
  台中: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_ba193f28dc"), places: ["審計新村", "草悟道", "勤美誠品綠園道", "宮原眼科"] },
      { title: canonicalEditorialTheme("theme_8202fd31d5"), places: ["逢甲夜市", "一中商圈", "第二市場"] },
      { title: canonicalEditorialTheme("theme_4da4f5d9b8"), places: ["宮原眼科", "彩虹眷村", "台中公園"] },
      { title: canonicalEditorialTheme("theme_6c91b8a90a"), places: ["高美濕地", "東海藝術街", "梧棲漁港"] },
    ],
  },
  臺中: {
    categories: ["文創聚落", "商圈夜市", "地標拍照", "近郊自然"],
  ...
  台南: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_d4fc41bd27"), places: ["赤崁樓", "孔廟", "林百貨", "祀典武廟"] },
      { title: canonicalEditorialTheme("theme_8a180e7cb2"), places: ["國華街", "神農街", "花園夜市"] },
      { title: canonicalEditorialTheme("theme_83b2933c27"), places: ["安平老街", "安平古堡", "億載金城"] },
      { title: canonicalEditorialTheme("theme_0142687fb9"), places: ["藍晒圖", "河樂廣場", "奇美博物館", "十鼓文創園區"] },
    ],
  },
  臺南: {
    categories: ["古蹟文化", "巷弄美食", "港區", "文創"],
  ...
  高雄: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_5df2891385"), places: ["駁二藝術特區", "大港橋", "哈瑪星"] },
      { title: canonicalEditorialTheme("theme_97aba8e197"), places: ["愛河", "美麗島", "鹽埕埔"] },
      { title: canonicalEditorialTheme("theme_0bbdb8aef7"), places: ["旗津", "西子灣", "鼓山渡輪站"] },
      { title: canonicalEditorialTheme("theme_85dbcd6185"), places: ["瑞豐夜市", "六合夜市", "衛武營"] },
    ],
  },
  台北: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_4da4f5d9b8"), places: ["台北101", "中正紀念堂", "龍山寺", "象山"] },
      { title: canonicalEditorialTheme("theme_147a9268b0"), places: ["松山文創園區", "華山1914", "迪化街"] },
      { title: canonicalEditorialTheme("theme_af89863b49"), places: ["饒河夜市", "寧夏夜市", "西門町", "信義商圈"] },
      { title: canonicalEditorialTheme("theme_6d2ac13d43"), places: ["北投溫泉", "陽明山", "淡水老街"] },
    ],
  },
  臺北: {
    categories: ["經典地標", "文創市集", "夜市商圈", "自然近郊"],
  ...
  桃園: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_d2b1b2179b"), places: ["桃園忠烈祠暨神社文化園區", "虎頭山公園", "桃園美術館"] },
      { title: canonicalEditorialTheme("theme_04911800fa"), places: ["大溪老街", "中壢夜市", "大溪老茶廠"] },
      { title: canonicalEditorialTheme("theme_6aa245d15a"), places: ["小人國主題樂園", "埔心牧場", "Xpark"] },
      { title: canonicalEditorialTheme("theme_2a2b413ada"), places: ["石門水庫", "小烏來", "慈湖"] },
    ],
  },
  台東: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_b85f0bc0a9"), places: ["多良車站", "小野柳", "加路蘭", "三仙台"] },
      { title: canonicalEditorialTheme("theme_7c0a6912dd"), places: ["鐵花村", "台東森林公園", "卑南遺址", "台東觀光夜市"] },
      { title: canonicalEditorialTheme("theme_32d144d003"), places: ["池上", "伯朗大道", "鹿野高台", "初鹿牧場"] },
      { title: canonicalEditorialTheme("theme_daa0fe56df"), places: ["綠島", "蘭嶼"] },
    ],
  },
  臺東: {
    categories: ["海岸", "縱谷", "市區", "離島"],
  ...
  東京: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_71bba8a2e5"), places: ["淺草寺", "東京晴空塔", "上野公園", "阿美橫町"] },
      { title: canonicalEditorialTheme("theme_771e62fd0b"), places: ["澀谷十字路口", "原宿", "表參道", "新宿"] },
      { title: canonicalEditorialTheme("theme_4e43060c11"), places: ["明治神宮", "皇居外苑", "日本橋", "銀座"] },
      { title: canonicalEditorialTheme("theme_7cdd1a1640"), places: ["東京塔", "六本木", "台場", "豐洲市場"] },
      { title: canonicalEditorialTheme("theme_bc316a1e1c"), places: ["橫濱", "川崎", "千葉", "埼玉", "鎌倉"] },
    ],
  },
  大阪: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_8d6e72303e"), places: ["大阪城", "道頓堀", "心齋橋", "黑門市場"] },
      { title: canonicalEditorialTheme("theme_e23240bc05"), places: ["くくる道頓堀店", "一蘭道頓堀店", "かに道楽本店", "だるま新世界本店"] },
      { title: canonicalEditorialTheme("theme_1e9e66cda0"), places: ["環球影城", "海遊館", "天保山"] },
      { title: canonicalEditorialTheme("theme_bc316a1e1c"), places: ["奈良", "京都", "神戶"] },
    ],
  },
  名古屋: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_910a61a15f"), places: ["名古屋城", "熱田神宮", "名古屋電視塔", "綠洲21"] },
      { title: canonicalEditorialTheme("theme_e23240bc05"), places: ["矢場とん本店", "ひつまぶし名古屋備長", "今池世界の山ちゃん", "みそかつの矢場とん"] },
      { title: canonicalEditorialTheme("theme_eedbc8b057"), places: ["榮商圈", "大須商店街", "星ヶ丘テラス", "名鐵百貨"] },
      // Places filled by Region Adjacency at build time (犬山／常滑／瀨戶…).
      { title: canonicalEditorialTheme("theme_bc316a1e1c"), places: ["犬山", "常滑", "瀨戶", "岐阜"] },
    ],
  },
  京都: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_4bfc6241af"), places: ["清水寺", "伏見稻荷大社", "祇園", "八坂神社"] },
      { title: canonicalEditorialTheme("theme_63b7902780"), places: ["嵐山", "竹林小徑", "天龍寺", "渡月橋"] },
      { title: canonicalEditorialTheme("theme_ed6b7bf347"), places: ["金閣寺", "銀閣寺", "哲學之道", "南禪寺"] },
      { title: canonicalEditorialTheme("theme_bc316a1e1c"), places: ["宇治", "奈良", "大阪"] },
    ],
  },
  首爾: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_5c4df00975"), places: ["景福宮", "北村韓屋村", "仁寺洞", "光化門"] },
      { title: canonicalEditorialTheme("theme_6514e16f32"), places: ["弘大", "梨大", "聖水洞", "延南洞"] },
      { title: canonicalEditorialTheme("theme_8c22b5374a"), places: ["明洞", "東大門", "廣藏市場", "樂天世界塔"] },
      { title: canonicalEditorialTheme("theme_8fb8b59f2b"), places: ["南山首爾塔", "漢江", "汝矣島"] },
      { title: canonicalEditorialTheme("theme_bc316a1e1c"), places: ["仁川", "水原", "城南"] },
    ],
  },
  濟州: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_fd330b0d16"), places: ["城山日出峰", "漢拿山", "牛島", "天地淵瀑布"] },
      { title: canonicalEditorialTheme("theme_674e4a81f1"), places: ["涯月海邊", "挾才海水浴場", "涉地可支", "月汀里海灘"] },
      { title: canonicalEditorialTheme("theme_69caa8b5fd"), places: ["黑豬肉一條街", "東門市場", "西歸浦每日偶來市場", "五日市市場"] },
      { title: canonicalEditorialTheme("theme_3bd16b7d00"), places: ["蓮洞商圈", "濟州中央地下街", "保建洞商圈", "濟州東門市場"] },
    ],
  },
  曼谷: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_901b10d309"), places: ["大皇宮", "玉佛寺", "鄭王廟", "臥佛寺"] },
      { title: canonicalEditorialTheme("theme_c2e9676571"), places: ["恰圖恰市集", "ICONSIAM", "暹羅商圈", "CentralWorld"] },
      { title: canonicalEditorialTheme("theme_349868e70e"), places: ["喬德夜市", "考山路", "Asiatique", "湄南河"] },
      { title: canonicalEditorialTheme("theme_bc316a1e1c"), places: ["水上市場", "美功鐵道市場", "大城"] },
    ],
  },
  巴黎: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_4da4f5d9b8"), places: ["艾菲爾鐵塔", "凱旋門", "聖母院", "香榭麗舍大道"] },
      { title: canonicalEditorialTheme("theme_92ef6de4e0"), places: ["羅浮宮", "奧塞美術館", "龐畢度中心"] },
      { title: canonicalEditorialTheme("theme_4388d9e098"), places: ["聖日耳曼", "拉丁區", "盧森堡公園"] },
      { title: canonicalEditorialTheme("theme_bc316a1e1c"), places: ["凡爾賽宮", "迪士尼樂園"] },
    ],
  },
  紐約: {
    ...
    themes: [
      { title: canonicalEditorialTheme("theme_4da4f5d9b8"), places: ["自由女神", "帝國大廈", "時代廣場", "中央公園"] },
      { title: canonicalEditorialTheme("theme_92ef6de4e0"), places: ["大都會博物館", "現代藝術博物館", "古根漢美術館"] },
      { title: canonicalEditorialTheme("theme_f87d526ccf"), places: ["蘇活", "格林威治村", "布魯克林大橋"] },
      { title: canonicalEditorialTheme("theme_bbebc1e413"), places: ["頂樓觀景台", "布魯克林大橋夜景", "洛克斐勒中心"] },
    ],
  },
};
...
const THEME_TITLE_POOL = [
  ...
  "商圈市集組合",
  "藝文博物館組合",
  canonicalEditorialTheme("theme_6c91b8a90a"),
];
