...
export const PLACE_DETAILS_SCREEN_FIELD_MASK =
  "id,displayName,formattedAddress,location,rating,userRatingCount,photos,primaryType,types,regularOpeningHours,currentOpeningHours,businessStatus,utcOffsetMinutes,websiteUri,googleMapsUri,nationalPhoneNumber,internationalPhoneNumber";
